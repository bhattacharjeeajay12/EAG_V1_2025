...
if __name__ == "__main__":
    ollamaObj = OllamaEmbeddingProvider()
    result_1 = ollamaObj.embed_query("Hello world")
    print(len(result_1)) # --> 768

    OpenAiObj = OpenAIEmbeddingProvider()
    result_2 = OpenAiObj.embed_query("Hello world")
    print(len(result_2))  # --> 1536
