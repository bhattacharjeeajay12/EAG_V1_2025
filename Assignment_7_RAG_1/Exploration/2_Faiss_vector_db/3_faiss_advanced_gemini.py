"""
- This script performs advanced document chunking and semantic search using Google Gemini embeddings and FAISS.
- Steps performed:
    ...
    - Gets embeddings for each chunk using Gemini.
...
- Useful for scalable document search and retrieval with chunk-level granularity.
"""
import os
