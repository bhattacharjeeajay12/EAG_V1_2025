"""
- This script performs semantic search over a small corpus of jokes using Google Gemini embeddings and FAISS.
- Steps performed:
    - Loads Gemini API key from environment.
    - Defines a list of jokes with metadata.
    - Gets embeddings for each joke using Gemini.
...
- Useful for demonstrating vector search with metadata and multi-result retrieval.
"""
